...
class VideoCamera(object):
	...
	def get_frame(self):
		...
		for (x,y,w,h) in face_rects:
			cv2.rectangle(image,(x,y-50),(x+w,y+h+10),(	260, 250, 55),5)
			...
			#print(df1)
			cv2.putText(image, emotion_dict[maxindex], (x+20, y-60), cv2.FONT_HERSHEY_SIMPLEX, 1, (25, 331, 136), 2, cv2.LINE_AA)
			df1 = music_rec()
